            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <i class="fa fa-align-justify"></i> Productos Vendidos
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <select class="form-control col-md-3" v-model="criterio">
                                      <option value="nombres">Nombre Cliente</option>
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                ...
                                <tr v-for="venta in arrayVentas" :key="venta.id">
                                    ...
                                    <td v-text="venta.nombre_producto"></td>
    ...
    export default {
        ...
        methods : {
            ...
            listarVenta (page, buscar, criterio){
                let me=this;
                var url = '/ventap?page=' + page + '&buscar=' + buscar + '&criterio=' + criterio + '&id=' + this.user_id;
