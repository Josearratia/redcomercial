...
<template>
    <main class="main">
            <!-- Breadcrumb -->
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#" @click="irmicrositio(empresa)"> IR A MI SITIO </a></li>
            </ol>
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <i class="fa fa-align-justify"></i> Mis Productos
                                ...
                                <tr v-for="articulo in arrayArticulo" :key="articulo.id">
                                    <td>
                                        ...
                                        <button type="button" @click="abrirModal('articulo','actualizar',articulo)" class="btn btn-warning btn-sm" >
                                          ...
                                          <button type="button" @click="eliminar(articulo)" class="btn btn-danger btn-sm" >
                                          <i class="icon-pencil"></i>
                                        </button> &nbsp;
    ...
    export default {
        ...
        methods : {
            ...
            listarEArticulo (page, buscar, criterio){
                let me=this;
                var url = '/pdempresa?page=' + page + '&buscar=' + buscar + '&criterio=' + criterio + '&id=' + this.user_id;
                axios.get(url).then(function(response){
                     ...
                     me.arrayArticulo.forEach(datos => {
                         me.empresa = datos.id_empresa;
               ...
               //funcion para registrar articulo
                ...
                eliminar(articulo){
                     ...
                     swal({
                        ...
                        if (result.value) {
                            let me = this;
                            axios.delete('pdempresa/destroy/' + articulo.id + '',{
