    ...
    <div class="row">
      ...
      <div class="col-lg-9">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4" v-for="producto in arrayProducto" :key="producto.id">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" :src="producto.imagen_producto"  alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#" v-text="producto.nombre_producto">Item One</a>
                </h4>
                <span> $<span v-text="producto.precio"></span></span>
                <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet numquam aspernatur!</p>
              </div>
              <div class="card-footer">
                <div class="input-group-append">
                  <button class="btn btn-primary" type="button">Comprar</button>
                  <button class="btn btn-danger" type="button"><i class="fas fa-shopping-cart"></i></button>
                 </div>
    ...
    export default {
        ...
        computed:{
         ...
         methods : {
            ...
            listarProducto(page){
                let me=this;
                var url = '/micrositio_productos?page=' + page + '&id=' + this.empresa_id;
                axios.get(url).then(function(response){
                     var respuesta = response.data;
                     me.arrayProducto = respuesta.empresas.data;  //pasamos los datos al arrayproductos 
